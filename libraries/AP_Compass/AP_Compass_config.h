...
#if defined(AP_COMPASS_PROBING_ENABLED) && !defined(HAL_PROBE_EXTERNAL_I2C_COMPASSES)
// Backport compatibility: older hwdef generation may still emit AP_COMPASS_PROBING_ENABLED.
#define HAL_PROBE_EXTERNAL_I2C_COMPASSES AP_COMPASS_PROBING_ENABLED
#endif
